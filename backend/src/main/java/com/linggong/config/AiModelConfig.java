...
/**
 * AI 大模型 Bean 装配：DeepSeek（OpenAI 兼容）非流式 + 流式模型。
 *
...
public class AiModelConfig {
    ...
    public AiModelConfig(@Value("${linggong.ai.base-url:https://api.deepseek.com}") String baseUrl,
                         @Value("${linggong.ai.api-key:}") String apiKey,
                         @Value("${linggong.ai.model-name:deepseek-chat}") String modelName) {
